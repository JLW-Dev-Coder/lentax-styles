/* lentax-tmp-coastal.js
 * Theme-specific loader for the TMP Coastal (teal/navy/seafoam/sand) skin.
 * Loads lentax-base.css + themes/tpp-coastal.css.
 *
 * TMP reuses the shared TPP theme CSS (themes/tpp-coastal.css) per the
 * TPP+TMP shared-variant architecture — no separate tmp-*.css exists.
 * Functionally identical to lentax-install-coastal.js; only the product label
 * differs. If TMP later needs its own palette, split the theme CSS then.
 * Ported: 2026-06-19.
 *
 * Pasted into SuiteDash Custom JS on TMP Coastal portals.
